...
const AuthenticatedDesktopHeader = () => {
    ...
    return (
        <Toolbar variant="regular"
                 sx={{borderBottomWidth: 1, borderBottomStyle: 'solid', borderBottomColor: 'secondary.main'}}>
            <Container>
                <Grid container={true} alignItems="center" justifyContent="space-around">
                    ...
                    <Grid alignItems="center" container={true} lg={10} spacing={2} justifyContent="flex-end">
                        <Grid item={true}>
                            <Avatar
                                sx={{
                                    borderWidth: 2,
...
export default AuthenticatedDesktopHeader
